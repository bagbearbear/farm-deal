package com.farmdeal.global.enums;
...
public enum ErrorCode {
    ...
    NOT_FOUND_AUTHORITY("권한을 찾을 수 없습니다."),
    ...
    NOT_SELLER_ERROR("판매자 권한이 없습니다."),


    DISABLED_USER_ERROR("비활성화된 사용자입니다."),
    NOT_FOUND_WISHLIST("찜한 상품을 찾을 수 없습니다."),
    DUPLICATED_EMAIL("이미 존재하는 이메일입니다."),
    NOT_ENOUGH_STOCK("재고가 부족합니다."),
    ORDER_NOT_FOUND("주문을 찾을 수 없습니다."),
    NOT_ORDER_OWNER("주문자가 아닙니다."),
    DUPLICATED_ORDER("중복된 주문입니다."),
    ALREADY_WISHLIST("이미 찜한 상품입니다."),


    NOT_FOUND_PRODUCT_SEARCH_RESULT("상품 검색 결과를 찾을 수 없습니다."),


    INVALID_SEARCH_CONDITION("올바르지 않은 검색 조건입니다."),


    DUPLICATE_ORDER("중복된 주문입니다."),
    NOT_FOUND_KEYWORD("검색어를 찾을 수 없습니다.");
